...
using MVCCodeFirts.Models;

namespace MVCCodeFirts.Controllers
{
    public class DetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DetailID,Price,Amount,ProductId,InvoiceID")] Detail detail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DetailID,Price,Amount,ProductId,InvoiceID")] Detail detail)
        {
            if (ModelState.IsValid)
            {
